...
function createSnakeCasedFiles(items, baseDir = '.') {
  items.forEach((item) => {
    // Convert item to snake_case and add .json extension
    const fileName = item.split('.').join('_') + '.json';
    ...
    const content = JSON.stringify(
      {
        ...
        title: item,
        description: 'Slack API endpoint for ' + item,
        type: 'object',
        properties: {},
      },
      null,
...
createSnakeCasedFiles(items, '../tap-test');
